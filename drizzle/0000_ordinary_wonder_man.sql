...
CREATE TABLE IF NOT EXISTS "t3-starter-template_post" (
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "t3-starter-template_post" ADD CONSTRAINT "t3-starter-template_post_created_by_t3-starter-template_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."t3-starter-template_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "account_user_id_idx" ON "t3-starter-template_account" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "created_by_idx" ON "t3-starter-template_post" ("created_by");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "name_idx" ON "t3-starter-template_post" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "session_user_id_idx" ON "t3-starter-template_session" ("user_id");